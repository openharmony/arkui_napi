...
public:
    ...
    virtual NativeValue* RunScriptBuffer(NativeEngine* engine, const char* path, std::vector<uint8_t>& buffer) = 0;
    ...
    virtual bool BuildJsStackInfoList(std::vector<JsFrameInfo>& jsFrames) = 0;
