...
//typedef napi_value (*NapiAttachCallback)(NativeEngine* engine, void* value, void* hint);
...
//     virtual void GetCString16(char16_t* buffer, size_t bufSize, size_t* copyLength) = 0;
