...
QuickJSNativeEngineImpl::QuickJSNativeEngineImpl(JSRuntime* runtime, JSContext* context, void* jsEngine)
    : NativeEngineInterface(jsEngine)
{
    runtime_ = runtime;
    context_ = context;
        ...
        [](JSContext* ctx, JSValueConst thisVal, int argc, JSValueConst* argv, int magic,
            ...
            if (module != nullptr && module->registerCallback != nullptr) {
                ...
                if (value != nullptr) {
                    ...
                    module->registerCallback(nativeEngine, value);
