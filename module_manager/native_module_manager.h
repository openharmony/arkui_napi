...
public:
    ...
    // Variant with loadErrInfo outparam for precise SO load failure diagnostics.
    NativeModule* LoadNativeModuleWithErrorInfo(const char* moduleName, const char* path, bool isAppModule,
