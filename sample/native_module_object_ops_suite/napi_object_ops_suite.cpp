...
// ============================================================================
// Test constants for verifying object operations
// ============================================================================
...
// ============================================================================
static napi_value TestGetOwnPropertyNames(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    ...
    NAPI_CALL(env, napi_get_all_property_names(env, obj, napi_key_own_only, napi_key_all_properties,
                                               napi_key_keep_numbers, &names));
    uint32_t count = GetPropertyCount(env, names);

    SetNamedBool(env, result, "ownOnlySuccess", true);
    SetNamedBool(env, result, "countCorrect", count == static_cast<uint32_t>(EXPECTED_OWN_COUNT_TWO));
...
// ============================================================================
static napi_value TestGetIncludePrototypeNames(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
    ...
    SetNamedInt32(env, obj, "alpha", TEST_INT_A);
    napi_value names = nullptr;
    NAPI_CALL(env, napi_get_all_property_names(env, obj, napi_key_include_prototypes, napi_key_all_properties,
                                               napi_key_keep_numbers, &names));
    uint32_t count = GetPropertyCount(env, names);
...
// ============================================================================
static napi_value TestGetWritableNames(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
    ...
    napi_value names = nullptr;
    NAPI_CALL(env, napi_get_all_property_names(env, obj, napi_key_own_only, napi_key_writable, napi_key_keep_numbers,
                                               &names));
    uint32_t count = GetPropertyCount(env, names);
...
// ============================================================================
static napi_value TestGetEnumerableNames(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
    ...
    napi_value names = nullptr;
    NAPI_CALL(env, napi_get_all_property_names(env, obj, napi_key_own_only, napi_key_enumerable, napi_key_keep_numbers,
                                               &names));
    uint32_t count = GetPropertyCount(env, names);
...
// ============================================================================
static napi_value TestGetConfigurableNames(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
    ...
    napi_value names = nullptr;
    NAPI_CALL(env, napi_get_all_property_names(env, obj, napi_key_own_only, napi_key_configurable,
                                               napi_key_keep_numbers, &names));
    uint32_t count = GetPropertyCount(env, names);
...
// ============================================================================
static napi_value TestGetSkipStringsNames(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
    ...
    napi_value names = nullptr;
    NAPI_CALL(env, napi_get_all_property_names(env, obj, napi_key_own_only, napi_key_skip_strings,
                                               napi_key_keep_numbers, &names));
    uint32_t count = GetPropertyCount(env, names);
...
// ============================================================================
static napi_value TestGetSkipSymbolsNames(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
    ...
    napi_value names = nullptr;
    NAPI_CALL(env, napi_get_all_property_names(env, obj, napi_key_own_only, napi_key_skip_symbols,
                                               napi_key_keep_numbers, &names));
    uint32_t count = GetPropertyCount(env, names);
...
// ============================================================================
static napi_value TestKeyNumbersToStrings(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
...
// ============================================================================
static napi_value TestKeyKeepNumbers(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
...
// ============================================================================
static napi_value GetterCallback(napi_env env, [[maybe_unused]] napi_callback_info info)
{
...
static napi_value TestDefineGetterOnly(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
    ...
    napi_value obj = nullptr;
    NAPI_CALL(env, napi_create_object(env, &obj));
    napi_property_descriptor desc = { "getterProp", nullptr, nullptr,      GetterCallback,
...
static napi_value TestDefineSetterOnly(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
    ...
    napi_value obj = nullptr;
    NAPI_CALL(env, napi_create_object(env, &obj));
    napi_property_descriptor desc = { "setterProp",   nullptr, nullptr,      nullptr,
                                      SetterCallback, nullptr, napi_default, nullptr };
    NAPI_CALL(env, napi_define_properties(env, obj, SINGLE_DESCRIPTOR, &desc));
...
static napi_value AccessorGetter(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value val = nullptr;
...
static napi_value TestDefineGetterSetter(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
    ...
    napi_value obj = nullptr;
    NAPI_CALL(env, napi_create_object(env, &obj));
    napi_property_descriptor desc = { "accessorProp", nullptr, nullptr,      AccessorGetter,
                                      AccessorSetter, nullptr, napi_default, nullptr };
    NAPI_CALL(env, napi_define_properties(env, obj, SINGLE_DESCRIPTOR, &desc));
    napi_value valToSet = nullptr;
...
// ============================================================================
static napi_value TestDefineStaticAttribute(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
    ...
    napi_property_descriptor desc = { "staticProp", nullptr, nullptr, nullptr, nullptr, val, napi_static, nullptr };
    NAPI_CALL(env, napi_define_properties(env, obj, SINGLE_DESCRIPTOR, &desc));
    bool hasProp = false;
...
// ============================================================================
static napi_value TestHasOwnVsHasProperty(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
...
// ============================================================================
static napi_value TestGetNamesComparison(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
    ...
    NAPI_CALL(env, napi_get_all_property_names(env, obj, napi_key_own_only, napi_key_all_properties,
                                               napi_key_keep_numbers, &allNames));
...
// ============================================================================
static napi_value TestSymbolKeySetGet(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
...
// ============================================================================
static napi_value TestHasElement(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
...
// ============================================================================
static napi_value TestDeleteElement(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
...
// ============================================================================
static napi_value TestPropertyAttrWritable(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
    ...
    napi_property_descriptor desc = { "writeProp", nullptr, nullptr, nullptr, nullptr, val, napi_writable, nullptr };
    NAPI_CALL(env, napi_define_properties(env, obj, SINGLE_DESCRIPTOR, &desc));
    napi_value readBack = nullptr;
...
// ============================================================================
static napi_value TestPropertyAttrEnumerable(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
...
// ============================================================================
static napi_value TestPropertyAttrConfigurable(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
...
static napi_value TestPropertyAllAttributes(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    ...
    napi_property_descriptor desc = { "allProp", nullptr, nullptr, nullptr, nullptr, val, allAttrs, nullptr };
    NAPI_CALL(env, napi_define_properties(env, obj, SINGLE_DESCRIPTOR, &desc));
    // Verify writable
    napi_value newVal = nullptr;
...
// ============================================================================
static napi_value TestManyProperties(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
    ...
    SetNamedBool(env, result, "allPropsCreated", count == static_cast<uint32_t>(STRESS_PROP_COUNT));
...
static napi_value TestCreateObjectWithProperties(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    ...
    napi_property_descriptor descs[TWO_DESCRIPTORS] = {
        { "propA", nullptr, nullptr, nullptr, nullptr, valA, napi_default, nullptr },
        { "propB", nullptr, nullptr, nullptr, nullptr, valB, napi_default, nullptr },
    };
    napi_value obj = nullptr;
...
// ============================================================================
static napi_value TestCreateObjectWithNamedProperties(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
    ...
    napi_value obj = nullptr;
    NAPI_CALL(env, napi_create_object_with_named_properties(env, &obj, THREE_DESCRIPTORS, keys, values));
    bool hasA = false;
...
// ============================================================================
static napi_value TestFreezeNoNewProps(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
...
// ============================================================================
static napi_value TestSealConfigurableLocked(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
...
// ============================================================================
static napi_value TestDefineMultipleDescriptors(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
    ...
    SetNamedInt32(env, result, "definedCount", static_cast<int32_t>(THREE_DESCRIPTORS));
    return result;
}
...
// ============================================================================
static napi_value TestDeleteSymbolProperty(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
...
// ============================================================================
static napi_value TestCombinedKeyFilters(napi_env env, [[maybe_unused]] napi_callback_info info)
{
    napi_value result = CreateResult(env);
    if (result == nullptr) {
        return nullptr;
    ...
    napi_key_filter combined = static_cast<napi_key_filter>(napi_key_writable | napi_key_enumerable);
    napi_value names = nullptr;
    NAPI_CALL(env,
              napi_get_all_property_names(env, obj, napi_key_own_only, combined, napi_key_numbers_to_strings, &names));
    uint32_t count = GetPropertyCount(env, names);

    SetNamedBool(env, result, "combinedFilterSuccess", true);
    SetNamedBool(env, result, "foundProps", count == static_cast<uint32_t>(EXPECTED_OWN_COUNT_THREE));
...
static const napi_property_descriptor OBJECT_OPS_TESTS[] = {
    { "testGetOwnPropertyNames", nullptr, TestGetOwnPropertyNames, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testGetIncludePrototypeNames", nullptr, TestGetIncludePrototypeNames, nullptr, nullptr, nullptr, napi_default,
      nullptr },
    { "testGetWritableNames", nullptr, TestGetWritableNames, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testGetEnumerableNames", nullptr, TestGetEnumerableNames, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testGetConfigurableNames", nullptr, TestGetConfigurableNames, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testGetSkipStringsNames", nullptr, TestGetSkipStringsNames, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testGetSkipSymbolsNames", nullptr, TestGetSkipSymbolsNames, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testKeyNumbersToStrings", nullptr, TestKeyNumbersToStrings, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testKeyKeepNumbers", nullptr, TestKeyKeepNumbers, nullptr, nullptr, nullptr, napi_default, nullptr },
    ...
    { "testDefineGetterOnly", nullptr, TestDefineGetterOnly, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testDefineSetterOnly", nullptr, TestDefineSetterOnly, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testDefineGetterSetter", nullptr, TestDefineGetterSetter, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testDefineStaticAttribute", nullptr, TestDefineStaticAttribute, nullptr, nullptr, nullptr, napi_default,
      nullptr },
    { "testHasOwnVsHasProperty", nullptr, TestHasOwnVsHasProperty, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testGetNamesComparison", nullptr, TestGetNamesComparison, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testSymbolKeySetGet", nullptr, TestSymbolKeySetGet, nullptr, nullptr, nullptr, napi_default, nullptr },
    ...
    { "testHasElement", nullptr, TestHasElement, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testDeleteElement", nullptr, TestDeleteElement, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testPropertyAttrWritable", nullptr, TestPropertyAttrWritable, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testPropertyAttrEnumerable", nullptr, TestPropertyAttrEnumerable, nullptr, nullptr, nullptr, napi_default,
      nullptr },
    { "testPropertyAttrConfigurable", nullptr, TestPropertyAttrConfigurable, nullptr, nullptr, nullptr, napi_default,
      nullptr },
    { "testPropertyAllAttributes", nullptr, TestPropertyAllAttributes, nullptr, nullptr, nullptr, napi_default,
      nullptr },
    { "testManyProperties", nullptr, TestManyProperties, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testGetPrototype", nullptr, TestGetPrototype, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testCreateObjectWithProperties", nullptr, TestCreateObjectWithProperties, nullptr, nullptr, nullptr,
      napi_default, nullptr },
    { "testCreateObjectWithNamedProperties", nullptr, TestCreateObjectWithNamedProperties, nullptr, nullptr, nullptr,
      napi_default, nullptr },
    { "testFreezeNoNewProps", nullptr, TestFreezeNoNewProps, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testSealConfigurableLocked", nullptr, TestSealConfigurableLocked, nullptr, nullptr, nullptr, napi_default,
      nullptr },
    { "testDefineMultipleDescriptors", nullptr, TestDefineMultipleDescriptors, nullptr, nullptr, nullptr, napi_default,
      nullptr },
    { "testDeleteSymbolProperty", nullptr, TestDeleteSymbolProperty, nullptr, nullptr, nullptr, napi_default, nullptr },
    { "testCombinedKeyFilters", nullptr, TestCombinedKeyFilters, nullptr, nullptr, nullptr, napi_default, nullptr },
};

static constexpr size_t OBJECT_OPS_TEST_COUNT = sizeof(OBJECT_OPS_TESTS) / sizeof(OBJECT_OPS_TESTS[0]);
